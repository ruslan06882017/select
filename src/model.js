...
/*    new TextColumnsBlock([
    ...
    <span> Самые свежие хлебобулочные изделия в городе предлагает наша пекарня. Мы «Выпечка №1», и это не просто слова, а цель, которую мы ежедневно достигаем. 
       Наши сотрудники не первый год удовлетворяют запросы покупателей на недорогую и вкусную продукцию. 
       Количество наших клиентов постоянно растет, и мы будем рады видеть вас в их числе. </span>`
  ], {
    styles: 'padding: 1rem;'
  }), */
